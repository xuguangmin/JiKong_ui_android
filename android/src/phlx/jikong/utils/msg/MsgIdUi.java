package phlx.jikong.utils.msg;

public final class MsgIdUi 
{
	public static final int MSG_WIFI_STATUS       = 1;   // WIFI状态
	 ...
	 * 其他消息 
	 */
	public static final int MSG_UI_LOAD_CCC       = 11;  // 显示集控的控制界面文件
	public static final int MSG_UI_LOG_MESSAGE    = 12;
}
