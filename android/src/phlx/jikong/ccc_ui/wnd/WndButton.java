...
public class WndButton extends Button  
                      implements WndBase, View.OnTouchListener, View.OnClickListener
{
	...
	public WndButton(Context context)
	{
		super(context);
	...
	{
		m_callback.WndEvent(WND_TYPE_BUTTON, WND_EVENT_CLICK, 0, m_uiBase);
	}
		...
		case MotionEvent.ACTION_DOWN:
			{
				...
				this.invalidate();  
				m_callback.WndEvent(WND_TYPE_BUTTON, WND_EVENT_PRESSED, 0, m_uiBase);
			}
			break;
		case MotionEvent.ACTION_UP:
			{
				...
				this.invalidate();
				m_callback.WndEvent(WND_TYPE_BUTTON, WND_EVENT_RELEASED, 0, m_uiBase);
			}
			break;
	...
	public void SetSize(int x, int y, int width, int height)
	{
		...
		//System.out.printf("--- WndButton SetSize x = %d, y = %d, width = %d, height = %d\n", x, y, width, height);
	}
	@Override
	public void Clear()
	{
